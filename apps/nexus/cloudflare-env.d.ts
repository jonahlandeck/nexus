/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 602ad37bf35e5c6249718e1bede03f47)
...
interface __BaseEnv_CloudflareEnv {
	...
	AUTHENTIK_CLIENT_SECRET: SecretsStoreSecret;
	AUTHENTIK_API_TOKEN: SecretsStoreSecret;
	ASSETS: Fetcher;
	...
	WORKER_SELF_REFERENCE: Fetcher /* nexus-console */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTHENTIK_CLIENT_ID" | "AUTHENTIK_ISSUER" | "AUTHENTIK_API_URL" | "AUTH_URL" | "AUTH_TRUST_HOST">> {}
}
